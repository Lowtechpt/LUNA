  ...
  return (
    <div className="pt-20 bg-[#050505] text-white">
      <Helmet>
        ...
        <meta name="keywords" content="Soluções de Visualização Tridimensional, Ativações de Marca Tecnológicas, Display LED Transparente 4K, Hologramas 3D, Marketing Tecnológico, RSB" />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Líder em Soluções de Visualização Tridimensional e Ativações de Marca Tecnológicas.",
            "parentOrganization": {
              "@type": "Organization",
              "name": "RSB",
              "url": "https://www.rsb.pt"
            },
            "url": "https://ais-pre-2dosebgclvywyp4bsvceys-540161375987.europe-west2.run.app/",
            "logo": "https://rsb.pt/wp-content/uploads/2023/12/Logo-RSB-inv_.png",
            "contactPoint": {
              "@type": "ContactPoint",
      ...
      <section ref={heroRef} className="atmosphere relative min-h-screen flex items-center justify-center py-24 md:py-32 overflow-hidden">
        <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
          ...
          <div 
            className="absolute inset-0 w-[150vw] h-[150vh] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-60 mix-blend-screen z-10 pointer-events-none bg-cover bg-center"
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-cinematic text-5xl md:text-8xl lg:text-9xl mb-8">
              <span className="italic font-light text-white/80 block">{t('home.hero.title1')}</span>
              <span className="font-semibold tracking-tight block">{t('home.hero.title2')}</span>
            </h1>
